...
import urllib.parse
from database.config_log import success_log, error_log
import os
...
class DatabaseHandler:
    def __init__(self):
        ...
        self.config_Url.read('src/database/database.ini')
        ...
        if "@" in db['user'] or "@" in db['password']:
            ...
            if self.dbtype == "postgres":
                engine_string = "postgresql+psycopg2" + "://" + user + ":" + password + "@" + db['host'] + ":" + db['port'] + "/" + db['NAME']
            elif self.dbtype == "mysql":
                engine_string = "mysql+pymysql" + "://" + user + ":" + password + "@" + db['host'] + ":" + db['port'] + "/" + db['NAME']
        else:
            if self.dbtype == "postgres":
